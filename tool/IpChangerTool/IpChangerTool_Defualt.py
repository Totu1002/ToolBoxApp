...
while True:
	...
	if answer == '1':
		...
		ip_chenger_tool.set_ip(network_service,ip_address,subnetmask,router_ip)
		break
	elif answer == '2':
		...
		ip_chenger_tool.set_dhcp(network_service)
		ip_chenger_tool.interface_down(interface)
		ip_chenger_tool.interface_up(interface)
		break
	elif  answer == '99':
